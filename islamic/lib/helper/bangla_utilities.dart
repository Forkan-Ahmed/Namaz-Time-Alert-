...
class BanglaUtility {
  static String englishToBanglaDigit({int englishDigit=0}) {
  ...
  static bool isLeapYear({int year=0}) {
    if (year == null) {
  ...
  static String getBanglaYear({int day=0, int month=0, int year=0}) {
  ...
  static String getBanglaWeekday({int day=0, int month=0, int year=0}) {
    if (day == null && month == null && year == null) {
      DateTime now = DateTime.now();
  ...
  static String? getBanglaDay({int day=0, int month=0, int year=0}) {
    return getBanglaDateMonthYearSeason(
        day: day, month: month, year: year)['day'];
  }

  static String? getBanglaMonth({int day=0, int month=0, int year=0}) {
    return getBanglaDateMonthYearSeason(
        day: day, month: month, year: year)['month'];
  }

  static String? getBanglaMonthName({int day=0, int month=0, int year=0}) {
    return getBanglaDateMonthYearSeason(
        day: day, month: month, year: year)['monthName'];
  }

  static String? getBanglaSeason({int day=0, int month=0, int year=0}) {
    return getBanglaDateMonthYearSeason(
        day: day, month: month, year: year)['season'];
  }

  static String getBanglaDate({int day=0, int month=0, int year=0}) {
    var bangla =
