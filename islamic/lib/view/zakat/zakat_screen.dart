...
import 'package:search_islam/widget/custom_text_field.dart';
              ...
              CustomButton(
                ...
                onTap: () {
                  zakatProvider.calculateZakat(
                    cash: handCostController.text.isNotEmpty ? double.parse(handCostController.text) : 0.0,
                    bankColti: bankColtiController.text.isNotEmpty ? double.parse(bankColtiController.text) : 0.0,
                    bankDeposit: bankFixedDepositController.text.isNotEmpty ? double.parse(bankFixedDepositController.text) : 0.0,
                    shareBenefit: shareBenefitController.text.isNotEmpty ? double.parse(shareBenefitController.text) : 0.0,
                    gold: goldQuantityController.text.isNotEmpty ? double.parse(goldQuantityController.text ) : 0.0,
                    goldMarketPrice: goldPriceController.text.isNotEmpty ? double.parse(goldPriceController.text) : 0.0,
                    silver: silverQuantityController.text.isNotEmpty ? double.parse(silverQuantityController.text) : 0.0,
                    silverMarketPrice: silverPriceController.text.isNotEmpty ? double.parse(silverPriceController.text ) : 0.0,
                    assets: assetsController.text.isNotEmpty ? double.parse(assetsController.text ) : 0.0,
                    dueGetMoney: dueCostController.text.isNotEmpty ? double.parse(dueCostController.text) : 0.0,
                    otherGetMoney: otherGetMoneyController.text.isNotEmpty ? double.parse(otherGetMoneyController.text) : 0.0,
                    serviceCostMoney: serviceBoyController.text.isNotEmpty ? double.parse(serviceBoyController.text) : 0.0,
                    badCredit: kurenController.text.isNotEmpty ? double.parse(kurenController.text) : 0.0,
                  );
