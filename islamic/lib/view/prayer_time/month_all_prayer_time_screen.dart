...
class MonthAllPrayerTimeScreen extends StatelessWidget {
  Widget titleWidget(String key, String value,
      {double top = 3, double bottom = 0, int indexValue = 0, bool isSelectedScreen = false}) {
    return value != null
        ? Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Expanded(
                    flex: 4,
                    child: Text(value,
                        style: poppinsRegular.copyWith(fontSize: 16, color: isSelectedScreen ? Colors.white : Colors.black)))
              ],
            ),
          )
        : SizedBox.shrink();
    ...
    return SafeArea(
      child: Scaffold(
        appBar: PreferredSize(
            child: CustomAppBar(title: Strings.puro_maser_namajer_somoy_suci_dekhun),
          ...
          builder: (context, timeProvider, child) => ListView.builder(
              ...
              itemBuilder: (context, index) => Container(
                    ...
                    decoration: BoxDecoration(
                      color: timeProvider.dayIndex == index + 1 ? Colors.blueAccent : Colors.white,
                      ...
                      children: [
                        Text('${timeProvider.prayerTimePojoClass[index].date}-${DateTime.now().year}',
                            style: poppinsSemiBold.copyWith(
                                color: timeProvider.dayIndex == index + 1 ? Colors.white : Colors.blueAccent)),
...
//                 //selected: true,
//                 color: MaterialStateProperty.all<Color>(timeProvider.dayIndex == prayerTime.selectIndex ? Colors.blueAccent : Colors.transparent),
//                 cells: [
