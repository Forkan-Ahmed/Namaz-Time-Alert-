...
import 'package:search_islam/view/home/widget/prayer_time_widget.dart';
import 'package:search_islam/view/prayer_time/month_all_prayer_time_screen.dart';
...
class PrayerTimeScreen extends StatelessWidget {
    ...
    return Column(
      children: [
        Container(
            ...
            decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(5),
                color: index == prayerTimeProvider!.selectCurrentPrayerCode && isTodayPrayerTime ? Colors.blueAccent : Colors.transparent),
            child: Text(title,
  ...
  Widget _haramTimeWidget({required BuildContext context, PrayerTimeProvider? prayerTimeProvider, bool isTodayPrayerTime = true}) {
    return Container(
  ...
  Widget _tomorrowIftarSehriWidget({required BuildContext context, PrayerTimeProvider? prayerTimeProvider}) {
    return Container(
      padding: EdgeInsets.all(Dimensions.PADDING_SIZE_SMALL),
