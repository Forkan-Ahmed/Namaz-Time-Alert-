...
import 'package:search_islam/view/quran/hafeji_quran_screen.dart';
        ...
        if (isShowHafejiQuranSystem) {
          ...
          Navigator.of(context).push(MaterialPageRoute(
              builder: (_) => QuranDetailsScreen(
                    suraID: isFromSuraListScreen ? suraModel!.suraNo : 0,
                    title: isFromSuraListScreen ? suraModel!.banglaTranslator : 'পারা নংঃ ${paraModel!.paraNo}',
                    paraModel: isFromSuraListScreen ? ParaModel() : paraModel!,
