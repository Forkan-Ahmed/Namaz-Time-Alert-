...
import 'package:search_islam/view/quran/widget/sura_widget.dart';
      ...
      child: Scaffold(
          ...
          body: Consumer<QuraanShareefProvider>(
              builder: (context, quranProvider, child) => Column(
                    children: [
                      Container(
                        decoration: BoxDecoration(gradient: LinearGradient(colors: [const Color(0xFF0270EE), const Color(0xFF0270EE)])),
