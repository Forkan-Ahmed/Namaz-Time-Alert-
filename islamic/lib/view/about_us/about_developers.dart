...
import 'package:search_islam/utill/responsive_screen.dart';
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: <Widget>[
            ...
            Text('About Developers', style: TextStyle(fontFamily: 'Ex02')),
          ],
        ),
        ...
        child: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              ...
              getDevCard(context, '', 'Forkan Ahmed', '', 'Flutter Developer', 'mailto:forkanahmedit@gmail.com',
                  'assets/developer/forkan.jpg'),
              SizedBox(height: size.getWidthPx(10)),
              getDevCard(context, '', 'Shirajum Monira', '', 'Flutter Developer', 'mailto:shirajummonira572@gmail.com',
                  'assets/developer/monira.jpg'),
              SizedBox(height: size.getWidthPx(10)),
              getDevCard(context, '', 'Zannatun Nayem Ame', '', 'Flutter Developer', 'mailto:zannatunnayemamee@gmail.com',
                  'assets/developer/ame.jpg'),
            ],
          ),
        ),
      ),
                      ...
                      child: Center(
                        child: Container(
                            padding: new EdgeInsets.fromLTRB(
                                size.getWidthPx(6), size.getWidthPx(16), size.getWidthPx(16), size.getWidthPx(16)),
                            child: Column(
                              children: <Widget>[
                                Align(
                                    ...
                                    IconButton(
                                      ...
                                      onPressed: () async {
                                        ...
                                        if (await canLaunch(url)) {
                                          ...
                                          showCustomSnackBar("Can't Lauch $url", context);
                                        }
                                      },
                                    ),
                                    SizedBox(
