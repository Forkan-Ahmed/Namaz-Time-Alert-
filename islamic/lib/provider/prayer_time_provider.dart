...
class PrayerTimeProvider with ChangeNotifier {
  ...
  PrayerTimeProvider({required this.locationRepo});
  ...
  late PrayerTimes currentPrayerTimes;
  ...
  int minutes=0;
  int seconds=0;
  int iftarSehriDays=0;
  int iftarSehriHours=0;
  int iftarSehriMinutes=0;
  int iftarSehriSeconds=0;
